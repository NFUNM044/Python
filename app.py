...
#导入数据
df1 = pd.read_csv('/home/wenpur/final_program/Financial_education.csv') #地方财政教育支出(亿元)
df2 = pd.read_csv('/home/wenpur/final_program/Schools.csv')             #特殊教育学校数(所)
df3 = pd.read_csv('/home/wenpur/final_program/Teachers.csv')            #特殊教育专任教师数(万人)
df4 = pd.read_csv('/home/wenpur/final_program/Recruit_students.csv')    #特殊教育招生数(万人)
df5 = pd.read_csv('/home/wenpur/final_program/Students_in_school.csv')  #各省特殊教育在校学生数(万人)
df6 = pd.read_csv('/home/wenpur/final_program/All.csv')    #全国特殊教育在校学生生数(人)
df7 = pd.read_csv('/home/wenpur/final_program/data.csv')
